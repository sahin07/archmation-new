...
import type { ImpactStatsContent } from "@/content/impact-stats/types";
...
export default function ImpactStatsSection({ content }: ImpactStatsSectionProps) {
    ...
    >
      ...
      <div className="archmation-stats__inner">
        <motion.div
          ...
          transition={{ duration: 0.8, ease: easeOut }}
        >
          <p className="archmation-stats__label">{content.label}</p>
          <h2 className="archmation-stats__title">{content.title}</h2>
