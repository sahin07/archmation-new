...
import "@/components/floating-social-buttons.css";

function WhatsAppIcon() {
  return (
    <svg
      className="floating-social__icon"
      viewBox="0 0 24 24"
      fill="currentColor"
      aria-hidden="true"
    >
...
export default function FloatingSocialButtons() {
  const { whatsapp, linkedin } = FLOATING_SOCIAL_LINKS;

  return (
    <aside className="floating-social" aria-label="Contact shortcuts">
      <a
        href={whatsapp.href}
